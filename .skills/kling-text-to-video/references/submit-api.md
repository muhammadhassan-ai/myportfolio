...
| Property | Value |
|----------|-------|
| Endpoint | `POST https://app-cs5atss9375t-api-qYGWo8XA7JVY.gateway.appmedo.com/v1/videos/text2video` |
| HTTP Method | `POST` |
...
async function submitTextToVideo(
  ...
  const response = await fetch(
    "https://app-cs5atss9375t-api-qYGWo8XA7JVY.gateway.appmedo.com/v1/videos/text2video",
    {
      method: "POST",
      headers: {
