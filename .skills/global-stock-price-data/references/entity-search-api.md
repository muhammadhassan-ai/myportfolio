...
**Endpoint:** `GET https://app-cs5atss9375t-api-Xa6JZq205MNa.gateway.appmedo.com/v1/entity/search`
...
async function searchEntities(params: EntitySearchParams = {}): Promise<EntitySearchResponse> {
  ...
  const response = await fetch(
    `https://app-cs5atss9375t-api-Xa6JZq205MNa.gateway.appmedo.com/v1/entity/search?${query.toString()}`,
