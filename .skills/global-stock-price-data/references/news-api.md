...
**Endpoint:** `GET https://app-cs5atss9375t-api-AalZze1qEWML.gateway.appmedo.com/v1/news/all`
...
async function getFinanceNews(params: NewsParams = {}): Promise<NewsResponse> {
  ...
  const response = await fetch(
    `https://app-cs5atss9375t-api-AalZze1qEWML.gateway.appmedo.com/v1/news/all?${query.toString()}`,
