...
| Item | Details |
|------|---------|
| Endpoint | `POST https://app-cs5atss9375t-api-rY7JZvg0dqdL.gateway.appmedo.com/v1/videos/image2video` |
...
async function submitImageToVideo(params: {
  ...
  const response = await fetch(
    "https://app-cs5atss9375t-api-rY7JZvg0dqdL.gateway.appmedo.com/v1/videos/image2video",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
